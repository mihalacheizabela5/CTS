...
public class Logger implements ILogging{
	...
	//the ctor should be private
	private Logger(String filename, String messagePattern) throws InvalidArgumentException, IOException{
	...
	public void log(String message) {
		...
		String log = String.format("%s %s - %s", LocalDateTime.now().toString(), this.messagePattern, message);
